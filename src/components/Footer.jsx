...
export default function Footer() {
  return (
    <footer id="reachout" className="bg-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8">
        {/* contact */}
        <div>
          <h4 className="font-bold text-lg mb-3">Reach Out</h4>
          <p>Email: <a href="mailto:contact@lbc.org" className="underline hover:text-indigo-300">vikasarjunpragada43@gmail.com</a></p>
          <p>Phone: +91 9642996657</p>
